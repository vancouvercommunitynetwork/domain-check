...
#import pprint   # The pprint module provides a capability to pretty-print arbitrary Python data structures in a form which can be used as input to the interpreter.
        ...
        for row in domains:           #start loop
            ...
            if isValid == 0:
                ...
                if domains[i].startswith('www.'): #remove www.
                    ...
                    domain_whois = domains[i][5:]print 'Found invalid IP: ' + domains[i] + ': '+ row[0]
